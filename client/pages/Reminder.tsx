  ...
  return (
    <div className="min-h-screen bg-white pb-36 flex flex-col">
      ...
      <div className="flex-1 px-6 py-6 pb-10 space-y-8">
        {currentDay && (
          <div>
            <h2 className="text-xl font-bold mb-4 text-[#010618]">
              {currentDay.title}
            </h2>
              ...
              <div key={group.classId} className="mb-6">
                <div className="flex justify-between items-center mb-3">
                  ...
                  <button
                    ...
                    onClick={() =>
                      group.reminders[0] &&
                      handleEdit(group.classId, group.reminders[0].id)
                    }
                  >
                    <svg
                      className="w-6 h-6"
                  ...
                  {group.reminders.map((reminder) => (
                    ...
                    >
                      <button
                        type="button"
                        onClick={() =>
                          handleToggleComplete(group.classId, reminder.id)
                        }
      ...
      <div className="flex justify-center items-center gap-8 px-6 pb-10">
        ...
        <span className="text-xl font-bold text-[#010618]">
          {currentDay?.date}
        </span>
        <button
          type="button"
