    ...
    <div className="min-h-screen bg-white pb-36 flex flex-col">
      ...
      <div className="px-6 pt-4 flex items-center justify-between">
        <button
          ...
          onClick={() => navigate(-1)}
        >
          <svg className="w-5 h-5 text-[#010618]" viewBox="0 0 24 24" fill="currentColor">
            <path d="M15.41 7.41L14 6L8 12L14 18L15.41 16.59L10.83 12L15.41 7.41Z" />
          </svg>
        </button>
        <h2 className="text-[32px] font-bold text-[#010618] tracking-tight">글쓰기</h2>
        <div className="w-10" />
      </div>

      <form onSubmit={handleSubmit} className="flex-1 flex flex-col gap-6 px-6 pt-6">
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm font-semibold text-[#010618]">첨부파일</label>
          ...
          >
            <span className="text-slate-600 truncate pr-4">{attachmentName}</span>
            <span className="px-3 py-1 rounded-full bg-[#80B3FF] text-white text-xs font-semibold">파일 선택</span>
          </label>
        </div>
