              ...
              <div className="flex flex-col items-end gap-2.5 w-20">
                ...
                >
                  <svg className="w-4.5 h-4.5" viewBox="0 0 18 18" fill="none">
                    <path
                      d="M11.655 9.6363L12.2913 9L7.20003 3.9087L5.92743 5.1813L9.74523 9L5.92743 12.8187L7.20003 14.0913L11.655 9.6363Z"
                      fill="#010618"
                    />
                  </svg>
                  <div className="text-xs text-[#010618] text-center">
                    {schedule.startTime}
                  </div>
                </button>
                <div className="text-xs text-[#010618] text-right">
                  {schedule.endTime}
                </div>
              </div>
              ...
              <div className="flex-1 flex flex-col gap-4">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-1">
                    <div className="text-xs text-[#21283F]">
                      {schedule.class}
                    </div>
                        ...
                        <div className="flex items-center gap-1">
                          <div className="w-4 h-4 bg-[#F66B6B] rounded-full flex items-center justify-center">
                            <span className="text-white text-xs text-center">
                              {
                                schedule.reminders.filter((r) => !r.completed)
                                  .length
                              }
                            </span>
                          </div>
        ...
        <div className="fixed inset-0 bg-white z-50 overflow-y-auto">
          <div className="min-h-screen flex flex-col">
            ...
            <div className="flex flex-col gap-6 px-6 pt-2">
              <h1 className="text-xl font-bold text-[#010618] text-center">
                2025 / 11
              </h1>
              ...
              <div className="flex gap-2">
                <div className="flex flex-col items-end pt-1">
                  <button className="flex items-start gap-1 mb-2">
                    ...
                    >
                      <path
                        d="M8.36371 11.655L9.00001 12.2913L14.0913 7.19997L12.8187 5.92737L9.00001 9.74517L5.18131 5.92737L3.90871 7.19997L8.36371 11.655Z"
                        fill="#010618"
                      />
                    </svg>
                    <div className="text-sm text-[#010618]">
                ...
                <div className="flex-1 flex flex-col gap-4">
                  ...
                  {reminders.length > 0 && (
                    <div className="flex flex-col gap-6">
                      <div className="flex items-center gap-1">
                        <div className="text-base font-bold text-[#010618]">
                          리마인더
                        </div>
                        <div className="w-4 h-4 bg-[#F66B6B] rounded-full flex items-center justify-center">
                          <span className="text-white text-xs">
                  ...
                  <div className="flex items-start gap-2 mt-4">
                    ...
                    >
                      <span className="text-base font-bold text-[#010618]">
                        닫기
                      </span>
                    </button>
                    <button
