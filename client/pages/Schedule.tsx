        ...
        <div className="grid grid-cols-5 gap-4 items-start mb-6">
          {scheduleDays.map((day) => (
            <div key={day.date} className="w-full">
              {day.type === "today" ? (
                <div className="w-full min-h-[96px] rounded-2xl bg-[#80B3FF] py-2 px-2 flex flex-col items-center justify-center gap-1">
                ...
                <div className="w-full min-h-[96px] flex flex-col items-center justify-center gap-1">
                  <div className="text-xl font-bold text-[#21283F]">{day.date}</div>
                  <div className="text-xs text-slate-400">{day.day}</div>
                  {day.badge && (
                    <div className="mt-1 w-4 h-4 bg-[#F66B6B] rounded-full flex items-center justify-center">
                      <span className="text-white text-[10px] font-semibold">{day.badge}</span>
                    </div>
                  )}
                </div>
              )}
